...
export default function CheckoutPage({
  ...
  return (
    <div className="bg-gray-10 w-full flex flex-1 flex-col">
      <section className="flex flex-col flex-1 justify-center pb-10 text-base font-semibold text-center bg-gray-10 text-zinc-900 pt-[58px] max-md:pt-[76px] mx-auto gap-4 h-full w-full max-w-[1440px]">
